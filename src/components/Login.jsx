        ...
        <table>
          ...
          <tbody>
            {eventLiveNowData.map(event => {
              ...
              return (
                <tr className={`fifo ${selectedOdds[event.id] && selectedOdds[event.id].marketId === event.marketIds[0] && selectedOdds[event.id].typeId === event.typeId ? 'selected-odd' : ''}`} key={event.id}>
