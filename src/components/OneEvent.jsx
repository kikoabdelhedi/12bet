...
const OneEvent = () => {
  ...
  const [selectedOddIndex, setSelectedOddIndex] = useState(null);
                ...
                <table className="odds-table">
                  ...
                  <tbody>
                    {selectedOddNames.map((name, idx) => (
                      <tr key={idx} onClick={() => handleCellClick(nameCom, name, selectedOddPrices[idx], startDate, selectedMarket.id, idx)}
                        className={selectedOddIndex === idx ? 'selected-odd' : ''}>
                        <td>{name}</td>
